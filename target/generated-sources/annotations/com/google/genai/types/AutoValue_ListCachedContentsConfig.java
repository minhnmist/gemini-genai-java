...
final class AutoValue_ListCachedContentsConfig extends ListCachedContentsConfig {
  ...
  private AutoValue_ListCachedContentsConfig(
  ...
  public String toString() {
    return "ListCachedContentsConfig{"
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListCachedContentsConfig) {
      ListCachedContentsConfig that = (ListCachedContentsConfig) o;
  ...
  public ListCachedContentsConfig.Builder toBuilder() {
    return new AutoValue_ListCachedContentsConfig.Builder(this);
  }
  ...
  static final class Builder extends ListCachedContentsConfig.Builder {
    ...
    Builder(ListCachedContentsConfig source) {
    ...
    @Override
    ListCachedContentsConfig.Builder httpOptions(Optional<HttpOptions> httpOptions) {
      if (httpOptions == null) {
    ...
    @Override
    public ListCachedContentsConfig.Builder pageSize(Integer pageSize) {
      this.pageSize = Optional.of(pageSize);
      return this;
    }
    @Override
    ListCachedContentsConfig.Builder pageSize(Optional<Integer> pageSize) {
      if (pageSize == null) {
    ...
    @Override
    public ListCachedContentsConfig.Builder pageToken(String pageToken) {
      this.pageToken = Optional.of(pageToken);
      return this;
    }
    @Override
    ListCachedContentsConfig.Builder pageToken(Optional<String> pageToken) {
      if (pageToken == null) {
    ...
    public ListCachedContentsConfig build() {
      return new AutoValue_ListCachedContentsConfig(
          this.httpOptions,
          this.pageSize,
          this.pageToken);
    }
